package kabam.rotmg.messaging.impl.data
{
   ...
   public class StatData
   {
      ...
      public static const RAT_BAGS:int = 86;
      ...
      public static function statToPlayerValues(param1:int, param2:Player) : Vector.<int>
      {
         switch(param1)
         {
            case 0:
               return new <int>[param2.maxHP_,param2.maxHPBoost_,param2.maxHPMax_];
            case 3:
               return new <int>[param2.maxMP_,param2.maxMPBoost_,param2.maxMPMax_];
            case 20:
               return new <int>[param2.attack_,param2.attackBoost_,param2.attackMax_];
            case 21:
               return new <int>[param2.defense_,param2.defenseBoost_,param2.defenseMax_];
            case 22:
               return new <int>[param2.speed_,param2.speedBoost_,param2.speedMax_];
            case 26:
               return new <int>[param2.vitality_,param2.vitalityBoost_,param2.vitalityMax_];
            case 27:
               return new <int>[param2.wisdom_,param2.wisdomBoost_,param2.wisdomMax_];
            case 28:
               return new <int>[param2.dexterity_,param2.dexterityBoost_,param2.dexterityMax_];
            case 114:
               return new <int>[param2.luck_,param2.luckBoost_,param2.luckMax_];
            case 112:
               return new <int>[param2.might_,param2.mightBoost_,param2.mightMax_];
            case 121:
               return new <int>[param2.restoration_,param2.restorationBoost_,param2.restorationMax_];
            case 122:
               return new <int>[param2.protection_,param2.protectionBoost_,param2.protectionMax_];
            default:
               return null;
         }
      }
